...
export const API_ERROR_CODE = {
  ...
  MEMBER_LEFT: "6012",
  /**
   * 이미 수락한 그룹 초대. 5006은 이미 거절한 초대(자동 거절 포함)다.
   *
   * 다른 탭·기기에서 먼저 응답했을 때 온다. 에러를 띄우기보다 **후보 목록을 다시 받아
  ...
  /**
   * 응답 대상이 이번 운영 주의 퀴즈셋이 아님(BE PR #176 / ADR 0026).
   *
   * 서버가 수락·거절·매칭 요청 경로에서 주차를 검사한다. 화면에 지난 주 카드가 남아 있었거나
   * (탭을 열어 둔 채 자정을 넘김) 다른 기기에서 먼저 응답한 뒤 들어온 경우라 **에러로 띄우기보다
   * 후보 목록을 다시 받아 화면을 맞추는 쪽이 맞다** — 다시 받으면 지난 주 카드는 사라진다.
   */
  MATCH_NOT_CURRENT_WEEK: "5008",
